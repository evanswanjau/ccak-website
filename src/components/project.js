    ...
    return (
        <Fade>
            ...
            >
                ...
                >
                    <div className="absolute inset-0 flex flex-col justify-end items-end h-full w-full bg-gradient-to-t from-black to-transparent px-3 pb-3 pt-28 rounded-lg group-hover:text-[#ED7423] transition duration-300 ease-in-out">
