                    ...
                    <div className="w-full lg:w-6/12 md:pr-5">
                        ...
                        <Slide bottom>
                            <p className="my-5 text-gray-600">
                                Joining our team at the Clean Cooking
                                Association of Kenya (CCAK) is an opportunity to
                                make a meaningful impact in the clean cooking
                                sector.
                                <br />
                                <br />
                ...
                <section className="text-center py-12">
                    ...
                    <Slide bottom>
                        <p className="w-full text-gray-600 px-6 lg:w-6/12 mx-auto">
                            ...
                            technologies, and work towards creating a
                            sustainable market environment for the sector.
                        </p>
                    </Slide>
