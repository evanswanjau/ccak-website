            ...
            <section className="text-center py-12">
                ...
                <Slide bottom>
                    <p className="w-full text-gray-600 px-6 lg:w-6/12 mx-auto">
                        Welcome to our external publications page! This is the
                        place where you can find a collection of the latest and
                        most innovative research in the clean cooking sector.
                    </p>
                </Slide>
                    ...
                    <div className="w-full">
                        ...
                        {!loading && data.length > 0 && (
                            <div className="grid grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 gap-y-6 sm:gap-6 py-10">
                                {data.map((item, i) => {
                                    return <ResearchRead key={i} data={item} />;
                                })}
                            </div>
                        )}
                    </div>
