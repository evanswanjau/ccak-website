...
export const InternalPublicationsPage = () => {
    ...
    return (
        <Page
            ...
            description="Welcome to our internal publications page! This is the place where you can find a collection of the latest and most innovative research in the clean cooking sector."
        >
                ...
                <section className="text-center py-12">
                    ...
                    <Slide bottom>
                        <p className="w-full text-gray-600 px-6 lg:w-6/12 mx-auto">
                            Welcome to our internal publications page! This is
                            the place where you can find a collection of CCAK's
                            publications.
                        </p>
                    </Slide>
