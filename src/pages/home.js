                    ...
                    <div className="lg:w-6/12 lg:pr-10">
                        ...
                        <Slide bottom>
                            <p className="my-5">
                                ...
                                sector and sector coordination.
                            </p>
                        </Slide>
                        <Slide bottom>
                            <p className="my-5">
                                ...
                                stakeholders to coordinate and advocate for the
                                sector.
                            </p>
                        </Slide>
                        <br />
                    ...
                    <div className="lg:w-6/12">
                        ...
                        <Slide bottom>
                            <p className="my-5 text-white">
                                The Clean Cooking Association of Kenya (CCAK) is
                                a not-for-profit business membership
