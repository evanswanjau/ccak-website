...
export const DropDown = ({ dropDown: { show, category }, setDropDown }) => {
    ...
    return (
        show && (
            <div className="fixed z-10 flex flex-wrap w-100 font-manjari text-gray-600 bg-white">
                ...
                <div
                    className={`w-4/12  bg-[url('${data.image}')] bg-cover bg-center bg-no-repeat`}
                ></div>
            </div>
        )
    );
